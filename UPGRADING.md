...
**_This release does not affect the consumer chains._**

## [v5.1.x](https://github.com/maany-xyz/ics/releases/tag/v5.1.1)

### Provider

**_Note that providers using v5.0.0 cannot upgrade to v5.1.1 cleanly_**
...
## [v5.0.0](https://github.com/maany-xyz/ics/releases/tag/v5.0.0)
...
## [v4.4.x](https://github.com/maany-xyz/ics/releases/tag/v4.4.0)
...
## [v4.3.x](https://github.com/maany-xyz/ics/releases/tag/v4.3.0)
...
## [v4.2.x](https://github.com/maany-xyz/ics/releases/tag/v4.2.0)

### Provider

Upgrading a provider from `v4.1.0` or `v4.1.0-lsm` to `v4.2.0` or `v4.2.0-lsm` requires state migrations, see relevant pull request [here](https://github.com/maany-xyz/ics/pull/1809)
...
## [v4.1.x](https://github.com/maany-xyz/ics/releases/tag/v4.1.0-rc2) and [v4.1.x-lsm](https://github.com/maany-xyz/ics/releases/tag/v4.1.0-lsm-rc2)

### Provider

Upgrading a provider from `v4.0.0` to `v4.1.0` or `v4.1.0-lsm` requires state migrations, see relevant pull request [here](https://github.com/maany-xyz/ics/pull/1762),
as well as the corresponding migrators [here](https://github.com/maany-xyz/ics/blob/release/v4.1.x/x/ccv/provider/migrations/migrator.go#L38) and [here](https://github.com/maany-xyz/ics/blob/release/v4.1.x-lsm/x/ccv/provider/migrations/migrator.go#L38).
...
## [v4.0.x](https://github.com/maany-xyz/ics/tree/release/v4.0.x)

`v4.0.x` sets the minimum required version of Go to `1.21`, see https://github.com/maany-xyz/ics/blob/release/v4.0.x/go.mod#L3.

### Provider

Upgrading a provider from `v3.3.0` to `v4.0.0` will require state migrations, see https://github.com/maany-xyz/ics/blob/release/v4.0.x/x/ccv/provider/migrations/migrator.go#L31.

### Consumer

**_Note that consumer chains can upgrade directly from `v3.1.0` to `v4.0.0`._**

Upgrading a consumer from `v3.2.0` to `v4.0.0` will not require state migration, however, upgrading directly from `v3.1.0` to `v4.0.0` will require state migrations, see https://github.com/maany-xyz/ics/blob/release/v4.0.x/x/ccv/consumer/keeper/migrations.go#L22.
...
## [v3.3.x](https://github.com/maany-xyz/ics/tree/release/v3.2.x)

### Provider

Upgrading the provider from `v2.x.y` to `v3.3.0` will not require state migration.

## [v3.2.x](https://github.com/maany-xyz/ics/tree/release/v3.2.x)

`v3.2.0` bumps IBC to `v7.3`. As a result, `legacy_ibc_testing` is not longer required and was removed, see https://github.com/maany-xyz/ics/pull/1185. This means that when upgrading to `v3.2.0`, any customized tests relying on `legacy_ibc_testing` need to be updated.

### Consumer

Upgrading the consumer from either `v3.0.0` or `v3.1.0` to `v3.2.0` will require state migrations, see https://github.com/maany-xyz/ics/blob/release/v3.2.x/x/ccv/consumer/keeper/migration.go#L25.

## [v3.0.x](https://github.com/maany-xyz/ics/releases/tag/v3.0.0-rc0)
...
Protobuf code generation, linting and formatting have been updated to leverage the `ghcr.io/cosmos/proto-builder:0.11.5` docker container. Replicated Security protobuf definitions are now packaged and published to [buf.build/maany-xyz/ics](https://buf.build/maany-xyz/ics) via CI workflows. The `third_party/proto` directory has been removed in favour of dependency management using [buf.build](https://docs.buf.build/introduction).
...
## [v2.0.x](https://github.com/maany-xyz/ics/releases/tag/v2.0.0)

### Provider

Upgrading a provider from `v1.1.0-multiden` to `v2.0.0` will require state migrations. See [migration.go](https://github.com/maany-xyz/ics/blob/v2.0.0/x/ccv/provider/keeper/migration.go).
