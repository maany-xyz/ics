...
- Simplifies [key-assignment code](https://github.com/maany-xyz/ics/blob/main/docs/docs/adrs/adr-001-key-assignment.md) because
...
- [EPIC](https://github.com/maany-xyz/ics/issues/1087)
