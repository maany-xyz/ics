...
- Throttling introduces a vector for a malicious consumer chain to halt the provider, see issue below.
  ...
  As an improvement, [using retries](https://github.com/maany-xyz/ics/issues/713) would fully prevent this attack vector.
...
- [Original issue inspiring throttling feature](https://github.com/maany-xyz/ics/issues/404)
- [Issue on DOS vector](https://github.com/maany-xyz/ics/issues/594)
- [Consideration of another attack vector](https://github.com/maany-xyz/ics/issues/685)
