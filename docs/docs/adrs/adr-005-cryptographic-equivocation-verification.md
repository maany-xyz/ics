...
- [ICS misbehaviour handling PR](https://github.com/maany-xyz/ics/pull/826)
- [Consumer double voting handler PR](https://github.com/maany-xyz/ics/pull/1232)
...
- [ADR on equivocation slashing](https://github.com/maany-xyz/ics/blob/main/docs/docs/adrs/adr-013-equivocation-slashing.md)
