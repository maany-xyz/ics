...
`AfterUnbondingInitiated` behavior was reverted to [ICS@v1.2.0-multiden](https://github.com/maany-xyz/ics/blob/v1.2.0-multiden/x/ccv/provider/keeper/hooks.go#L53)

The revert re-introduces an additional state check.

See this [issue](https://github.com/maany-xyz/ics/issues/1045) for more context and the actions taken.
