...
| 2.04 | Handling acknowledgments        | `Scheduled` (ibc-go) | [Scheduled](https://github.com/maany-xyz/ics/issues/362)                                                                                               | `Partial coverage` [TestOnAcknowledgementPacket](../../x/ccv/consumer/keeper/relay_test.go#152), [TestSlashPacketAcknowldgement](../../tests/integration/slashing.go) | `Done`             | `Scheduled` |
| 2.05 | Handling timeouts               | `Scheduled` (ibc-go) | [Scheduled](https://github.com/maany-xyz/ics/issues/362)                                                                                               | `NA`                                                                                                                                                                  | `Future work`      | `Scheduled` |
...
- minimum viable consumer chain ([mvcc](https://github.com/maany-xyz/ics/issues/139))
- governance-enabled consumer chain ([gov-cc](https://github.com/maany-xyz/ics/issues/141)), with the modified staking and distribution modules (see `x/ccv/staking` and `x/ccv/distribution`); also, must look at the [atom-gov module](https://github.com/maany-xyz/ics/issues/162)
- CosmWasm-enabled consumer chain ([wasm-cc](https://github.com/maany-xyz/ics/issues/143)), with the CosmWasm module enabled
